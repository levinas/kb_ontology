...
sub test_transformation {
    transform_from_and_back_to_obo("toy");
    transform_from_and_back_to_obo("go");
    transform_from_and_back_to_obo("po");
}
...
sub transform_from_and_back_to_obo {
    ...
    sysrun("../scripts/obo.pl --to-json $obo >$json");
    sysrun("../scripts/obo.pl --from-json $json >$obo.2");
